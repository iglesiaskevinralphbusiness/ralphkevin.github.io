...
(async () => {
    for(i=0; i<=100; i++){
       ...
       [page] = await browser.pages();
        ...
        await page.goto('http://mangariot.com/ads/all.html', { waitUntil: 'load', timeout: 0 });
        await page.waitForSelector('body', { waitUntil: ["networkidle0", "domcontentloaded"], timeout: 0 });
