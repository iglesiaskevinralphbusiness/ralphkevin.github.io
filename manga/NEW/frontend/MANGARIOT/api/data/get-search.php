<?php
    ...
    //select manga
    $sql = "SELECT * FROM manga WHERE name LIKE '%$keyword%'  ORDER BY convert(`total_views`, decimal) DESC LIMIT $page, $item_per_page";
    ...
    //select pagination
    $sql = "SELECT * FROM manga WHERE  name LIKE '%$keyword%'";
